...
with st.sidebar:
    ...
    selected = option_menu('Multiple Disease Prediction System',
                           ['Home',  # Add 'Home' as the first option
                            'Diabetes Prediction',
                            'Heart Disease Prediction',
                            'Breast Cancer Prediction',
                            'Lung Cancer Prediction',
                            'Parkinsons Disease Prediction'],
                           icons=['house','activity','heart-pulse','clipboard2-pulse','lungs','person'],
                           default_index=0)
...
if selected == 'Home':
    ...
    st.write("""
    This system allows you to predict the likelihood of several diseases using advanced machine learning models.
    Select a disease from the sidebar to start the prediction process.
    
    Available predictions include:
    - Diabetes Prediction
    - Heart Disease Prediction
    - Breast Cancer Prediction
    - Lung Cancer Prediction
    ...
    Please choose an option from the sidebar to proceed.
    """)
